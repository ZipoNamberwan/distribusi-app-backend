...
const props = defineProps({
    ...
    cardConfig: { type: Object, required: true }, // expects { columns: [...], header: fn, sections: fn }
...
const getSections = (record) => {
    return props.cardConfig.sections(record); // expect sections function that returns array of { title, color, items: [{value}] }
};
        ...
        <a-spin :spinning="loading">
            ...
            <div v-else class="flex flex-col gap-3 pb-4">
                <a-card v-for="(record, index) in data" :key="index" size="small" :bordered="true">
                    ...
                    <div class="grid grid-cols-3 text-center text-[11px] text-gray-500 font-semibold mb-1">
                    ...
                    <div class="flex flex-col">
                        <div v-for="(section, sIndex) in getSections(record)" :key="sIndex"
                            class="grid grid-cols-3 items-center px-2 py-1 rounded-sm"
